...
#include "AnimNode_MagicTwoBoneIK.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(AnimNode_MagicTwoBoneIK)
...
FAnimNode_MagicTwoBoneIK::FAnimNode_MagicTwoBoneIK()
...
void FAnimNode_MagicTwoBoneIK::GatherDebugData(FNodeDebugData& DebugData)
{
...
FTransform FAnimNode_MagicTwoBoneIK::GetTargetTransform(const FTransform& InComponentTransform, FCSPose<FCompactPose>& MeshBases, FMagicBoneSocketTarget& InTarget, EBoneControlSpace Space, const FVector& InOffset) 
{
...
void FAnimNode_MagicTwoBoneIK::EvaluateSkeletalControl_AnyThread(FComponentSpacePoseContext& Output, TArray<FBoneTransform>& OutBoneTransforms)
{
...
bool FAnimNode_MagicTwoBoneIK::IsValidToEvaluate(const USkeleton* Skeleton, const FBoneContainer& RequiredBones) 
{
...
void FAnimNode_MagicTwoBoneIK::InitializeBoneReferences(const FBoneContainer& RequiredBones) 
{
...
void FAnimNode_MagicTwoBoneIK::Initialize_AnyThread(const FAnimationInitializeContext& Context)
{
...
void FAnimNode_MagicTwoBoneIK::ConditionalDebugDraw(FPrimitiveDrawInterface* PDI, USkeletalMeshComponent* MeshComp) const
{

...
#include "AnimationMagic/BoneControllers/AnimNode_MagicTwoBoneIK.h"
#include "AnimGraphNode_MagicTwoBoneIK.generated.h"
...
UCLASS(MinimalAPI)
class UAnimGraphNode_MagicTwoBoneIK : public UAnimGraphNode_SkeletalControlBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(EditAnywhere, Category=Settings)
	FAnimNode_MagicTwoBoneIK Node;
